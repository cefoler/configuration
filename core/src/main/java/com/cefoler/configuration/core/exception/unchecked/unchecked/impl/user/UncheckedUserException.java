package com.cefoler.configuration.core.exception.unchecked.unchecked.impl.user;

import com.cefoler.configuration.core.exception.checked.user.UserException;
