package com.cefoler.configuration.core.exception.unchecked.user.impl.impl;

import com.cefoler.configuration.core.exception.unchecked.user.impl.InvalidUserException;
